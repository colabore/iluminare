...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paciente_paciente', (
            ...
            ('cidade', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('pais', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('cep', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
