...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgendaAtendimento'
        db.create_table('atendimento_agendaatendimento', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agenda_tratamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tratamento.AgendaTratamento'])),
            ('atendimento_origem', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='atendimentoorigem', null=True, to=orm['atendimento.Atendimento'])),
            ('atendimento_realizado', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='atendimentorealizado', null=True, to=orm['atendimento.Atendimento'])),
        ...
        db.send_create_signal('atendimento', ['AgendaAtendimento'])

        # Adding model 'Notificacao'
        db.create_table('atendimento_notificacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('fixo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('data_criacao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('data_validade', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('impressao', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tela_checkin', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('prazo_num', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('prazo_unidade', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('qte_atendimentos', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paciente.Paciente'])),
            ('atendimento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atendimento.Atendimento'], null=True, blank=True)),
        ))
        db.send_create_signal('atendimento', ['Notificacao'])


    def backwards(self, orm):
        # Deleting model 'AgendaAtendimento'
        db.delete_table('atendimento_agendaatendimento')

        # Deleting model 'Notificacao'
        db.delete_table('atendimento_notificacao')
    ...
    models = {
        ...
        'atendimento.notificacao': {
            ...
            'qte_atendimentos': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
