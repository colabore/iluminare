...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notificacao.atendimento'
        db.delete_column('atendimento_notificacao', 'atendimento_id')


    def backwards(self, orm):
        # Adding field 'Notificacao.atendimento'
        db.add_column('atendimento_notificacao', 'atendimento',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atendimento.Atendimento'], null=True, blank=True),
                      keep_default=False)
