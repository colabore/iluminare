...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notificacao.qte_atendimentos'
        db.delete_column('atendimento_notificacao', 'qte_atendimentos')

        # Adding field 'Notificacao.qtd_atendimentos'
        db.add_column('atendimento_notificacao', 'qtd_atendimentos',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Notificacao.qte_atendimentos'
        db.add_column('atendimento_notificacao', 'qte_atendimentos',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Notificacao.qtd_atendimentos'
        db.delete_column('atendimento_notificacao', 'qtd_atendimentos')
